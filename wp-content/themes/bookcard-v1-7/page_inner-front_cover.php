					...
					if ( $twitter_username != "" )
					{
						?>
							<aside class="widget widget-twitter">
								...
								<script src="<?php echo get_template_directory_uri(); ?>/js/blogger.js"></script>
								
								<script src="http://api.twitter.com/1/statuses/user_timeline/<?php echo $twitter_username; ?>.json?callback=twitterCallback2&amp;count=1&exclude_replies=true"></script>
							</aside>
						<?php
					}
					// end if
